...
async function main() {
  ...
  const brandsData = [
    ...
    },
    {
      name: 'Enamor',
      slug: 'enamor',
      logo: '/logos/enamor.png',
      description: 'Activewear and lingerie brand.',
      industry: Industry.FASHION,
      campaignTypes: [CampaignType.INSTAGRAM_POST, CampaignType.INSTAGRAM_REEL],
      budgetTier: BudgetTier.MACRO,
      requirements: { min_followers: 50000, min_engagement_rate: 4.0, content_requirements: 'Workout-to-weekend activewear' },
    },
    {
      name: 'Myntra',
      slug: 'myntra',
  ...
  await prisma.application.upsert({
    ...
    create: {
      ...
      proposal: 'My workout-to-weekend reels are my most-saved content. Enamor activewear fits that format perfectly.',
