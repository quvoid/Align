...
export const INITIAL_BRANDS: BrandItem[] = [
  ...
  },
  {
    ...
    budgetTier: 'Mid-Tier',
    description: 'Fitness and lifestyle creators needed to show Enamor activewear through a real workout-to-weekend day.',
    logo: 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=120&h=120&fit=crop',
    coverImage: 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=800&h=300&fit=crop',
    campaignTypes: ['Workout Reel', 'Try-On Haul', 'Product Review'],
    requirements: 'Fitness or lifestyle niche, 25k+ followers, active women 18–35 audience.',
    isActive: true,
    contactEmail: 'enamor@schbang.com',
    website: 'https://enamor.co.in',
    likesCount: 29,
  },
  {
    id: '4',
...
export const INITIAL_CREATORS: CreatorItem[] = [
  ...
  },
  {
    ...
    brandCollaborations: [
      {
        brandName: 'Enamor',
        brandLogo: 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=60&h=60&fit=crop',
        campaignTitle: 'Workout to Weekend',
        viewsDelivered: '490K',
        engagementRate: '8.4%',
...
export const INITIAL_APPLICATIONS: ApplicationItem[] = [
  ...
  },
  {
    ...
    status: 'SHORTLISTED',
    date: '2026-02-17',
    proposal: 'A 4K "Workout to Weekend" reel: one Enamor activewear set from a morning gym session straight into weekend errands, with a try-on close-up.',
    expectedRate: 35000,
    deliverables: ['1x Workout Reel (4K)', '1x Try-On Carousel'],
    metrics: {
